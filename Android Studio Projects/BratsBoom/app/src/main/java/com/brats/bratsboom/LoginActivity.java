        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(str_email)||TextUtils.isEmpty(str_password)) {
                    Toast.makeText(LoginActivity.this, "Butun yerlerin doldurulmasi zorunludur!", Toast.LENGTH_SHORT).show();
                }
                else{
                    auth.signInWithEmailAndPassword(str_email,str_password).addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(firebaseUser.isEmailVerified()) {
                                ...
                                pd.dismiss();
                                Toast.makeText(LoginActivity.this, "Lutfen Emailinizi kontrol ediniz!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
